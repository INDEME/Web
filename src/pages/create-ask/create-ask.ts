...
export class CreateAskPage {
  ...
  constructor(public navCtrl: NavController, public consulta: ConsultaProvider, private toastCtrl:ToastController, public alertCtrl:AlertController, public navParams: NavParams, public http:Http, public auth: AuthSevice) {
  ...
  ionViewDidLoad() {
    return new Promise(resolve => {
      this.consulta.getPollsByUser(this.IdentificadorUsuario).then(results => {
